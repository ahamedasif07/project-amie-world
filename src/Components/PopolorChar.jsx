  ...
  return (
    <div>
      <div className="flex lg:flex-row  flex-col-reverse  py-5  gap-24 justify-center items-center max-w-3xl mx-auto">
        <div data-aos="fade-right" className="px-4  text-left">
          ...
          <li className="text-gray-700 pt-2">
            ...
            freedom in this whole ocean… is the Pirate King!
          </li>
          <li className="text-gray-700 pt-2">
            If you don’t take risks, you can’t create a future!'
          </li>
          <li className="text-gray-700 pt-2">
            I’ve set myself to become the King of the Pirates… and if I die
            trying… then at least I tried!
          </li>
        </div>
      ...
      <div className="md:flex py-5   gap-24 justify-center  items-center max-w-3xl mx-auto">
        ...
        <div data-aos="fade-left" className="px-4 text-left">
          ...
          <li className="text-gray-700 pt-2">
            Because they saved me from myself, they rescued me from my
            loneliness. They were the first to accept me for who I am. They're
            my friends!'
          </li>
          <li className="text-gray-700 pt-2">
      ...
      <div className="flex py-5 lg:flex-row flex-col-reverse  gap-24 justify-center items-center max-w-3xl mx-auto">
        <div data-aos="fade-right" className="px-4 text-left">
          ...
          <li className="text-gray-700 pt-2">
            ...
            true. That’s how they define 'reality.' But what does it mean to be
            'correct' or 'true?' Merely vague concepts... Their 'reality' may
            all be a mirage.'
          </li>
          <li className="text-gray-700 pt-2">
            You don't become the Hokage to be acknowledged by everyone. The one
