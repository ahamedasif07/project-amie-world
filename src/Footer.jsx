import logo from '../src/assets/icons/navIcon.png'

const Footer = () => {
    return (
        <div>

<footer className="px-4 divide-y dark:bg-gray-100 mt-3 dark:text-gray-800">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-12 h-12 rounded-full ">
					<img className='transform hover:scale-110' src={logo} alt="" />
				</div>
				<span className="self-center text-2xl font-semibold">Anime World</span>
			</a>
		</div>
